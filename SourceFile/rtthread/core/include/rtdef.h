...
#define rt_inline                   static inline
#define RTT_API
#elif defined(__CCRH__) || defined(__RENESAS__)
/* Renesas CC-RH. Section/used/weak attributes are intentionally kept minimal
 * for this Nano reference port. RT_USING_COMPONENTS_INIT is disabled in
 * rtconfig.h, so INIT_EXPORT sections are not required. */
#define RT_SECTION(x)
#define RT_USED
#define ALIGN(n)
#define RT_WEAK
