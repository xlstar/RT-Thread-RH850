...
void R_ADC0_Create(void)
{
    ...
    ADCA0.SFTCR.UINT32 = _ADC_READ_CLEAR_ENABLED;
    ...
    ADCA0.SGMCYCR1.UINT32 = _ADC_MULTICYCLE_NUMBER_4;
    ADCA0.SGCR1.UINT32 = _ADC_SCAN_MODE_MULTICYCLE | _ADC_SCAN_END_INT_DISABLE | _ADC_HW_TRIGGER_DISABLE;
    /* Set ADC0 vitrual channel setting */
    //   ADCA0.VCR00.UINT32 = _ADC_VIRTUAL_CHANNEL_END_INT_ENABLE | _ADC_LIMIT_TABLE_SELECT_0 | _ADC_PHYSICAL_CHANNEL_AN03;
    //    ADCA0.VCR01.UINT32 = _ADC_VIRTUAL_CHANNEL_END_INT_ENABLE | _ADC_LIMIT_TABLE_SELECT_0 | _ADC_PHYSICAL_CHANNEL_AN14;
    ADCA0.VCR00.UINT32 = _ADC_VIRTUAL_CHANNEL_END_INT_ENABLE | _ADC_LIMIT_TABLE_SELECT_0 | _ADC_PHYSICAL_CHANNEL_AN15;
    ADCA0.VCR01.UINT32 = _ADC_VIRTUAL_CHANNEL_END_INT_ENABLE | _ADC_LIMIT_TABLE_SELECT_0 | _ADC_PHYSICAL_CHANNEL_AN29;
    /* Set T&H setting */
    ADCA0.THCR.UINT32 = _ADC_TH_SAMPLING_AUTOMATIC;
    ADCA0.THER.UINT32 = _ADC_TH5_DISABLED | _ADC_TH3_DISABLED;
