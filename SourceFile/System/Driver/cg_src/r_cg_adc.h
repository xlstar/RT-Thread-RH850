...
#define _ADC_TH_START_TRIGGER_USED             (0x00000000UL) /* trigger is selected for the hold start trigger of TH group A/B */
#define _ADC_TH_START_TRIGGER_UNUSED           (0x00000010UL) /* trigger is not selected for the hold start trigger of TH group A/B */
...
*/
/* Scan mode (SCANMD) */
#define _ADC_SCAN_MODE_MULTICYCLE              (0x00000000UL) /* Multicycle scan mode */
#define _ADC_SCAN_MODE_CONTINUOUS              (0x00000020UL) /* Continuous scan mode */
/* Scan end interrupt enable (ADIE) */
#define _ADC_SCAN_END_INT_DISABLE              (0x00000000UL) /* INT_SG1 is not output */
#define _ADC_SCAN_END_INT_ENABLE               (0x00000010UL) /* INT_SG1 is output */
/* Trigger mode (TRGMD) */
#define _ADC_HW_TRIGGER_DISABLE                (0x00000000UL) /* Trigger input is disabled */
#define _ADC_HW_TRIGGER_ENABLE                 (0x00000001UL) /* Start trigger or hold complete trigger selected for the trigger input */

/*
    Scan Group 1 Multicycle Register (ADCAnSGMCYCRm)
*/
/* Multicycle number specification (MCYC[1-0]) */
#define _ADC_MULTICYCLE_NUMBER_1               (0x00000000UL) /* Number of scans = 1 */
#define _ADC_MULTICYCLE_NUMBER_2               (0x00000001UL) /* Number of scans = 2 */
#define _ADC_MULTICYCLE_NUMBER_4               (0x00000003UL) /* Number of scans = 4 */

/*
    A/D force halt register (ADCAnSGTSELm)
*/
/* A/D conversion hardware trigger select (T1SEL8) */
#define _ADC_HW_TRIGGER_FACTOR_8               (0x00000100UL) /* Connection Motor control (PIC0) trigger enabled */
/* A/D conversion hardware trigger select (T1SEL7) */
#define _ADC_HW_TRIGGER_FACTOR_7               (0x00000080UL) /* Connection Motor control (TAPA0) trigger enabled */
/* A/D conversion hardware trigger select (T1SEL6) */
#define _ADC_HW_TRIGGER_FACTOR_6               (0x00000040UL) /* Connection Motor control (TAPA0) trigger enabled */
/* A/D conversion hardware trigger select (T1SEL5) */
#define _ADC_HW_TRIGGER_FACTOR_5               (0x00000020UL) /* Connection ENCA0 trigger enabled */
/* A/D conversion hardware trigger select (T1SEL4) */
#define _ADC_HW_TRIGGER_FACTOR_4               (0x00000010UL) /* Connection LPS trigger enabled */
/* A/D conversion hardware trigger select (T1SEL3) */
#define _ADC_HW_TRIGGER_FACTOR_3               (0x00000008UL) /* Connection TAUD0 trigger enabled */
/* A/D conversion hardware trigger select (T1SEL2) */
#define _ADC_HW_TRIGGER_FACTOR_2               (0x00000004UL) /* Connection TAUD0 trigger enabled */
/* A/D conversion hardware trigger select (T1SEL1) */
#define _ADC_HW_TRIGGER_FACTOR_1               (0x00000002UL) /* Connection TAUJ0 trigger enabled */
/* A/D conversion hardware trigger select (T1SEL0) */
#define _ADC_HW_TRIGGER_EXTERNAL_PIN           (0x00000001UL) /* Connection External trigger pin trigger enabled */

/***********************************************************************************************************************
Macro definitions
***********************************************************************************************************************/
#define _ADC0_UPPER_LIMIT_TABLE0                  (0x3FF00000UL)
#define _ADC0_LOWER_LIMIT_TABLE0                  (0x00000000UL)
#define _ADC0_UPPER_LIMIT_TABLE1                  (0x3FF00000UL)
#define _ADC0_LOWER_LIMIT_TABLE1                  (0x00000000UL)
#define _ADC0_UPPER_LIMIT_TABLE2                  (0x3FF00000UL)
...
bool R_ADC0_Sampling_Finished_Flag(void);
