...
void R_WDT0_Create(void)
{
    ...
    WDTA0.MD = _WDT_OVERFLOW_WDTACKI_2_14 | _WDT_INTERRUPT_DISABLED | _WDT_RESET_MODE | _WDT_PERIOD_100;
...
void R_WDT0_HardReset(void)
{
    ...
    INTC2.ICWDTA0.BIT.RFWDTA0 = _INT_REQUEST_NOT_OCCUR;
    /* Set WDT0 control setting */
    WDTA0.MD = _WDT_OVERFLOW_WDTACKI_2_9 | _WDT_INTERRUPT_DISABLED | _WDT_RESET_MODE | _WDT_PERIOD_100;
    /* Synchronization processing */
    g_cg_sync_read = WDTA0.MD;
    __syncp();
#else
...
{
    /* Disable WDT1 interrupt operation and clear request */
    INTC2.ICWDTA1.BIT.MKWDTA1 = _INT_PROCESSING_DISABLED;
    INTC2.ICWDTA1.BIT.RFWDTA1 = _INT_REQUEST_NOT_OCCUR;
    /* Set WDT1 control setting */
    WDTA1.MD = _WDT_OVERFLOW_WDTACKI_2_14 | _WDT_INTERRUPT_DISABLED | _WDT_RESET_MODE | _WDT_PERIOD_100;
    /* Synchronization processing */
    g_cg_sync_read = WDTA1.MD;
    __syncp();
}
/***********************************************************************************************************************
* Function Name: R_WDT1_Restart
* Description  : This function restarts WDTA module.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
